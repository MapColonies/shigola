...
func cleanPolygon(p shigola.Polygon) (polygons []basic.Polygon, invalids basic.Polygon) {
...
func cleanMultiPolygon(mpolygon shigola.MultiPolygon) (mp basic.MultiPolygon, err error) {
...
func MakeValid(geo shigola.Geometry) (basic.Geometry, error) {
	switch g := geo.(type) {
	/*
		case shigola.Point:
