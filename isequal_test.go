...
func TestIsPointEqual(t *testing.T) {
	...
	tests.Run(func(test testcase) {
		if test.expected != shigola.IsPointEqual(test.pt1, test.pt2) {
			match := "match."
			if !test.expected {
				match = "not " + match
			}
		...
		if test.expected != shigola.IsPointEqual(test.pt2, test.pt1) {
			match := "match."
			if !test.expected {
				match = "not " + match
			}
...
func TestIsMultiPointEqual(t *testing.T) {
	...
	tests.Run(func(test testcase) {
		if test.expected != shigola.IsMultiPointEqual(test.mpt1, test.mpt2) {
			match := "match."
			if !test.expected {
				match = "not " + match
			}
		...
		if test.expected != shigola.IsMultiPointEqual(test.mpt2, test.mpt1) {
			match := "match."
			if !test.expected {
				match = "not " + match
			}
...
func TestIsLineEqual(t *testing.T) {
	...
	tests.Run(func(test testcase) {
		if test.expected != shigola.IsLineStringEqual(test.ln1, test.ln2) {
			match := "match."
			if !test.expected {
				match = "not " + match
			}
		...
		if test.expected != shigola.IsLineStringEqual(test.ln2, test.ln1) {
			match := "match."
			if !test.expected {
				match = "not " + match
			}
...
func TestIsMultiLineEqual(t *testing.T) {
	...
	tests.Run(func(test testcase) {
		if test.expected != shigola.IsMultiLineEqual(test.lns1, test.lns2) {
			match := "match."
			if !test.expected {
				match = "not " + match
			}
		...
		if test.expected != shigola.IsMultiLineEqual(test.lns2, test.lns1) {
			match := "match."
			if !test.expected {
				match = "not " + match
			}
...
func TestIsPolygonEqual(t *testing.T) {
	...
	tests.Run(func(test testcase) {
		if test.expected != shigola.IsPolygonEqual(test.poly1, test.poly2) {
			match := "match."
			if !test.expected {
				match = "not " + match
			}
		...
		if test.expected != shigola.IsPolygonEqual(test.poly2, test.poly1) {
			match := "match."
			if !test.expected {
				match = "not " + match
			}
