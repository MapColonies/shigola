...
import (
	...
	"github.com/MapColonies/shigola/draw/svg"
	"github.com/MapColonies/shigola/maths/clip/region"
)
...
func LineString(img *image.RGBA, min maths.Pt, line shigola.LineString, c color.RGBA) {
	var ls []float64
...
func Polygon(img *image.RGBA, min maths.Pt, polygon shigola.Polygon, c color.RGBA) {
...
func DrawPolygonTest(writer io.Writer, w, h int, r *region.Region, original shigola.Polygon, expected []shigola.Polygon, got []shigola.Polygon) {
