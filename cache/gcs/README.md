...
GCS cache is an abstraction on top of Google Cloud Storage (GCS) which implements the shigola cache interface. To use it, you need to configure cache as the example below:
...
# optional
basepath="shigola"           # Basepath is a path prefix added to all cache operations inside of the GCS bucket
