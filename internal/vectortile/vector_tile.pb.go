// The Mapbox Vector Tile specification's schema (vector-tile-spec 2.1),
// verbatim except for the syntax declaration and the two options below.
//
...
//
// Reproduced rather than paraphrased because the field numbers here are the
// wire format: a tile shigola serves is read by clients generated from this
// same file. Why it is generated in this tree at all rather than taken from a
// library is in package vectortile's doc comment.

// Stated rather than left to protoc's default, which is proto2 -- what this
// schema is, with its `required`, `optional` and field defaults. The
// specification's file omits it; pinning it means a future protoc with a
// different default cannot silently reinterpret the file.
...
const file_vector_tile_proto_rawDesc = "" +
	"\n" +
	"\x11vector_tile.proto\x12\vvector_tile\"\xe3\x05\n" +
	"\x04Tile\x12/\n" +
	"\x06layers\x18\x03 \x03(\v2\x17.vector_tile.Tile.LayerR\x06layers\x1a\xf2\x01\n" +
	"\x05Value\x12!\n" +
	...
	"\n" +
	"bool_value\x18\a \x01(\bR\tboolValue*\b\b\b\x10\x80\x80\x80\x80\x02\x1a\x8d\x01\n" +
	"\aFeature\x12\x11\n" +
	...
	"\bgeometry\x18\x04 \x03(\rB\x02\x10\x01R\bgeometry\x1a\xdc\x01\n" +
	"\x05Layer\x12\x1b\n" +
	...
	"\aPOLYGON\x10\x03*\x05\b\x10\x10\x80@B6H\x03Z2github.com/MapColonies/shigola/internal/vectortile"
