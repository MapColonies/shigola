...
func (canvas *Canvas) DrawPolygon(p shigola.Polygon, id string, style string, pointStyle string, drawPoints bool) int {
	var points []maths.Pt
...
func (canvas *Canvas) DrawMultiPolygon(mp shigola.MultiPolygon, id string, style string, pointStyle string, drawPoints bool) int {
	canvas.Gid(id)
	count := 0
...
func (canvas *Canvas) DrawLine(l shigola.LineString, id string, style string, pointStyle string, drawPoints bool) {
	var points []maths.Pt
	pts := l.Subpoints()
...
func (canvas *Canvas) DrawMultiLine(ml shigola.MultiLine, id string, style string, pointStyle string, drawPoints bool) {
	canvas.Gid(id)
...
func (canvas *Canvas) DrawGeometry(geo shigola.Geometry, id string, style string, pointStyle string, drawPoints bool) int {
	count := 0
	switch g := geo.(type) {
