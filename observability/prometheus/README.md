...
metrics for Shigola's various subsystems.

The connection between Shigola and Prometheus is configured in the config
file (`shigola.toml`.) An example of minimum configuration :
...
* tags - the build tags that were used to build the Shigola Binary
...
* shigola_api_duration_seconds_sum
* shigola_api_duration_seconds_count
...
As part of a histogram include the support tags:
* shigola_api_response_size_sum
* shigola_api_response_size_count
...
* shigola_cache_duration_seconds_count
...
* shigola_cache_response_size_count
